//
// Advent of Code 2020, day 15, part two
//

// There might be a repeating pattern in the output we could look for, but
// the number of iterations is low enough we can simply run them.
...
int main()
{
	...
	for (long long turn = numbers.size(); turn < 30000000; ++turn) {
